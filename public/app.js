...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateFlightMarkers(flights) {
        ...
        flights.forEach(flight => {
            ...
            const popupContent = `<b>${flight.callsign} (${flight.aircraftName})</b><br>
   ...
   function createSettingsPanel() {
    ...
    function createHelpPanel() {
        const helpContent = `
            ...
            <div class="info-card">
                 <h3>Live Mode</h3>
                 <p style="font-size: 14px; color: #ddd; margin: 0;">Click 'Live Mode', select a server, and press 'Connect' to see real-time flight and ATC data from Infinite Flight.</p>
            </div>
            <div class="info-card">
                <h3>Drawing Tool</h3>
                <p style="font-size: 14px; color: #ddd; margin: 0;">To plan a flight path:</p>
